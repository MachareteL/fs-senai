# Generated by Django 4.2.1 on 2023-05-05 17:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_cliente_conta', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastbank.cliente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operacao', models.CharField(choices=[('D', 'Transferência Débito'), ('C', 'Transferência Crédito'), ('P', 'Transferência PIX')], default='D', max_length=1)),
                ('valor', models.DecimalField(decimal_places=2, max_digits=10)),
                ('codigo_cartao', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='fastbank.cartao')),
            ],
        ),
        migrations.CreateModel(
            name='Investimento',
            fields=[
                ...
                ('codigo_conta', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastbank.conta')),
            ],
        ),
        migrations.CreateModel(
            name='Emprestimo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_cliente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='fastbank.cliente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigo_cliente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastbank.cliente')),
                ('codigo_conta', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastbank.conta')),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='fastbank.endereco'),
        ),
        migrations.AddField(
            model_name='cliente',
            name='tipo_cliente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastbank.tipocliente'),
        ),
        migrations.AddField(
            model_name='cartao',
            name='conta_cartao',
